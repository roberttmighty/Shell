...
TOOLS=enter peopletools folder
...
##Example to start the Application A domain on a production server it would be the below
##    ./s_app.sh csprd start a 

##Start Script

psadmin -c $2 -d $ENV$DOM
